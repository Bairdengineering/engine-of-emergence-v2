      ...
      <div style={{background:"#0A0A0A",border:"1px solid #2A2A2A",borderRadius:14,
        ...
        <svg viewBox={`0 0 ${worldW} ${worldH}`} style={{display:"block",width:"100%",height:"auto"}} preserveAspectRatio="xMidYMid meet">
          ...
          <g fill="none" stroke="#3A6A4A" strokeWidth="0.9" opacity="0.6">
            ...
            <path d="M283.3,50.0 L291.7,70.0 L300.0,73.3 L313.3,76.7 L325.0,86.7 L330.0,83.3 L346.7,81.7 L350.0,73.3 L343.3,66.7 L330.0,53.3 L308.3,56.7 L300.0,63.3 L291.7,70.0 L283.3,76.7 L283.3,90.0 L300.0,91.7 L316.7,88.3 L341.7,88.3 L353.3,100.0 L358.3,110.0 L370.0,130.0 L373.3,136.7 L366.7,146.7 L370.0,153.3 L366.7,166.7 L360.0,180.0 L346.7,196.7 L343.3,206.7 L330.0,206.7 L326.7,196.7 L316.7,158.3 L300.0,141.7 L286.7,143.3 L276.7,136.7 L270.0,130.0 L270.0,116.7 L276.7,103.3 L286.7,93.3 L283.3,90.0 L283.3,50.0Z"/>
            <path d="M350.0,90.0 L360.0,100.0 L370.0,110.0 L391.7,113.3 L396.7,106.7 L393.3,100.0 L380.0,93.3 L366.7,90.0 L350.0,90.0Z"/>
            <path d="M346.7,33.3 L400.0,30.0 L466.7,30.0 L533.3,33.3 L566.7,36.7 L600.0,36.7 L600.0,58.3 L533.3,70.0 L500.0,73.3 L466.7,66.7 L433.3,63.3 L400.0,58.3 L366.7,53.3 L350.0,50.0 L346.7,41.7 L346.7,33.3Z"/>
